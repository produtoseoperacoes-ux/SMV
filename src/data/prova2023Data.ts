...
// PROVA 2023 - MARINHA DO BRASIL
// PS-SMV-OF/2023 - Serviço Militar Voluntário - Oficiais Temporários
// Áreas: Saúde (exceto Medicina), Apoio à Saúde, Técnica, Técnica-Magistério, Engenharia

export const PROVA_2023_ANSWER_KEY: { [key: number]: Answer } = {
...
export const PROVA_2023_TOPICS: { [key: number]: QuestionTopic } = {
